...
# %%
df_property_credit_pred=pd.read_csv('df_prop_pred_credit',names=['Property_pred'],skiprows=1)
df_property_debit_pred=pd.read_csv('df_prop_pred_debit',names=['Property_pred'],skiprows=1)
df_label_credit_pred=pd.read_csv('df_label_pred_credit',names=['Label_pred'],skiprows=1)
df_label_debit_pred=pd.read_csv('df_label_pred_debit',names=['Label_pred'],skiprows=1)
# %%

df_credit_pred=pd.concat([df_property_credit_pred,df_label_credit_pred],axis=1)
df_debit_pred=pd.concat([df_property_credit_pred,df_label_credit_pred],axis=1)
#%%
