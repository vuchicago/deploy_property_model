...
debit_file = 'Havu_debit2024.xlsx'

# %%
havu_debit = debit_xlsx_container.read(debit_file)
havu_debit.head()
# %%
...
debit2023='Havu_debit2023_fixed.xlsx'
df=debit_xlsx_container.read(debit2023)
...
havu_debit.head()
# %%
havu_debit.to_excel('Havu_debit2024_fixed.xlsx', index=False)
# %%
